...
@implementation MyPTFakeMetaTouch
...
+ (void)simulateTouch:(int)touchType x:(int)x y:(int)y identifier:(int)identifier{
    ...
    if(touchType == 0)
        [MyPTFakeMetaTouch fakeTouchId:identifier AtPoint:point withTouchPhase:UITouchPhaseEnded];
    else if(touchType == 1)
        [MyPTFakeMetaTouch fakeTouchId:identifier AtPoint:point withTouchPhase:UITouchPhaseBegan];
    else if(touchType == 2)
        [MyPTFakeMetaTouch fakeTouchId:identifier AtPoint:point withTouchPhase:UITouchPhaseMoved];
}
@end